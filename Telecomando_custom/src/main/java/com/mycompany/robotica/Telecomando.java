 ...
 */
package com.mycompany.robotica;

/**
 *
 * @author rocco
 */
public class Telecomando extends javax.swing.JFrame {

    /**
     * Creates new form Telecomando
     */
    public Telecomando() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Telecomando.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Telecomando().setVisible(true);
            }
        });
    }
